...
from apps.verification.settings import get_email_settings, get_phone_settings
from apps.verification.utils import PhoneVerification
...
class PhoneTest(TestCase):
    ...
    def test_attempt_limit(self):
        ...
        wrong_code = "XXX"
        for attempt in range(phone_settings["attempt_limit"]):
